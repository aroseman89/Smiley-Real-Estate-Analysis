...
top_10_agents_table %>%
  ...
  row_spec(0, bold = T, background = "#f2f2f2")
```
<small>The table above highlights the top 10 agents overall. For a complete listing of the best agent in every market analyzed, the complete, ranked list can be downloaded [here](best_agents_per_market.csv).</small>
