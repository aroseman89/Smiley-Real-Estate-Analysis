...
This first section is about cleaning and preparing the data. It's not very interesting and isn't very nice to look at, so it's hidden from this report. However, feel free to [view the complete code](Clever Real Estate Working Interview Project.Rmd) to see the full cleaning steps and take a look at the notes I left about why I made the corrections I did. But for now, let's get straight to the fun part!
